...
with col1:
    ...
    airline = st.selectbox(
        "Airline",
        ["SpiceJet", "AirAsia", "Vistara", "Air_India", "Indigo", "GO_FIRST"]
    )
...
def encode_features(airline, source_city, departure_time, stops, destination_city, travel_class, duration, days_left):
    # Create mappings (these should match your training data encoding)
    airline_map = {"SpiceJet": 0, "AirAsia": 1, "Vistara": 2, "Air_India": 3, "Indigo": 4, "GO_FIRST": 5}
    source_map = {"Delhi": 0, "Mumbai": 1, "Bangalore": 2, "Kolkata": 3, "Hyderabad": 4, "Chennai": 5}
    departure_map = {"Early_Morning": 0, "Morning": 1, "Afternoon": 2, "Evening": 3, "Night": 4, "Late_Night": 5}
    stops_map = {"zero": 0, "one": 1, "two_or_more": 2}
    destination_map = {"Delhi": 0, "Mumbai": 1, "Bangalore": 2, "Kolkata": 3, "Hyderabad": 4, "Chennai": 5}
    ...
    if model is None or scaler is None:
        ...
        if source_city == destination_city:
            ...
            try:
                ...
                with col1:
                    if stops == "zero":
                        st.success("✅ Non-stop flight - Faster but typically costs more")
                    elif stops == "one":
                ...
                st.info("Please ensure all fields are filled correctly and the model files are compatible.")
